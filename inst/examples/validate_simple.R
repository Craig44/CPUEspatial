...
#' gamma response variable with only fleet and year effects
...
intercept = mean(year_coef) + fleet_coef[1]
...
sampData$eta =  intercept + normalised_year_coef[sampData$year] + ifelse(sampData$fleet_ndx == 1, 0, fleet_coef[2] - fleet_coef[1])
