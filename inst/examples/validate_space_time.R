...
spatial_model_w_epsilon_NN = configure_obj(data = data, projection_df = full_proj_df, mesh = mesh, family = 2, link = 0, include_omega = T, include_epsilon = T, 
                                         response_variable_label = "y_i", time_variable_label = "year", catchability_covariates = "fleet_ndx", catchability_covariate_type = "factor", 
                                         spatial_covariates = c("region"), spatial_covariate_type = c("factor"), spline_catchability_covariates = NULL,
                                         spline_spatial_covariates = NULL, linear_basis = 1, trace_level = "none")

spatial_model_w_epsilon_w_pref_din = configure_obj(data = data, projection_df = full_proj_df, mesh = mesh, family = 2, link = 0, include_omega = T, include_epsilon = T, 
                                                 response_variable_label = "y_i", time_variable_label = "year", catchability_covariates = "fleet_ndx", catchability_covariate_type = "factor", 
                                                 spatial_covariates = c("region"), spatial_covariate_type = c("factor"), spline_catchability_covariates = NULL,
                                                 spline_spatial_covariates = NULL, apply_preferential_sampling = T, preference_model_type = 0,trace_level = "none")

spatial_model_w_epsilon_NN_w_pref_din = configure_obj(data = data, projection_df = full_proj_df, mesh = mesh, family = 2, link = 0, include_omega = T, include_epsilon = T, 
                                                    response_variable_label = "y_i", time_variable_label = "year", catchability_covariates = "fleet_ndx", catchability_covariate_type = "factor", 
                                                    spatial_covariates = c("region"), spatial_covariate_type = c("factor"), spline_catchability_covariates = NULL,
                                                    spline_spatial_covariates = NULL, linear_basis = 1, apply_preferential_sampling = T, preference_model_type = 0, trace_level = "none")

spatial_model_w_epsilon_w_pref_lgcp = configure_obj(data = data, projection_df = full_proj_df, mesh = mesh, family = 2, link = 0, include_omega = T, include_epsilon = T, 
                                                  response_variable_label = "y_i", time_variable_label = "year", catchability_covariates = "fleet_ndx", catchability_covariate_type = "factor", 
                                                  spatial_covariates = c("region"), spatial_covariate_type = c("factor"), spline_catchability_covariates = NULL,
                                                  spline_spatial_covariates = NULL, apply_preferential_sampling = T, preference_model_type = 1,trace_level = "none")

spatial_model_w_epsilon_NN_w_pref_lgcp = configure_obj(data = data, projection_df = full_proj_df, mesh = mesh, family = 2, link = 0, include_omega = T, include_epsilon = T, 
                                                     response_variable_label = "y_i", time_variable_label = "year", catchability_covariates = "fleet_ndx", catchability_covariate_type = "factor", 
                                                     spatial_covariates = c("region"), spatial_covariate_type = c("factor"), spline_catchability_covariates = NULL,
                                                     spline_spatial_covariates = NULL, linear_basis = 1, apply_preferential_sampling = T, preference_model_type = 1, trace_level = "none")

spatial_model_w_epsilon_w_pref_din$obj$gr()
spatial_model_w_epsilon_NN_w_pref_din$obj$gr()
spatial_model_w_epsilon_w_pref_lgcp$obj$gr()
spatial_model_w_epsilon_NN_w_pref_lgcp$obj$gr()
...
## estimate models
start_time = Sys.time()
opt_epsilon_pref_din = nlminb(spatial_model_w_epsilon_w_pref_din$obj$par, spatial_model_w_epsilon_w_pref_din$obj$fn, spatial_model_w_epsilon_w_pref_din$obj$gr, control = list(eval.max = 10000, iter.max = 10000))
opt_epsilon_pref_din$opt_time = Sys.time() - start_time
start_time = Sys.time()
opt_epsilon_NN_pref_din = nlminb(spatial_model_w_epsilon_NN_w_pref_din$obj$par, spatial_model_w_epsilon_NN_w_pref_din$obj$fn, spatial_model_w_epsilon_NN_w_pref_din$obj$gr, control = list(eval.max = 10000, iter.max = 10000))
opt_epsilon_NN_pref_din$opt_time = Sys.time() - start_time
start_time = Sys.time()
opt_epsilon_pref_lgcp = nlminb(spatial_model_w_epsilon_w_pref_lgcp$obj$par, spatial_model_w_epsilon_w_pref_lgcp$obj$fn, spatial_model_w_epsilon_w_pref_lgcp$obj$gr, control = list(eval.max = 10000, iter.max = 10000))
opt_epsilon_pref_lgcp$opt_time = Sys.time() - start_time
start_time = Sys.time()
opt_epsilon_NN_pref_lgcp = nlminb(spatial_model_w_epsilon_NN_w_pref_lgcp$obj$par, spatial_model_w_epsilon_NN_w_pref_lgcp$obj$fn, spatial_model_w_epsilon_NN_w_pref_lgcp$obj$gr, control = list(eval.max = 10000, iter.max = 10000))
opt_epsilon_NN_pref_lgcp$opt_time = Sys.time() - start_time

opt_epsilon_pref_din$opt_time
opt_epsilon_NN_pref_din$opt_time
opt_epsilon_pref_lgcp$opt_time 
opt_epsilon_NN_pref_lgcp$opt_time
## estimate preference parameter
rep_opt_epsilon_pref_din = spatial_model_w_epsilon_w_pref_din$obj$report(spatial_model_w_epsilon_w_pref_din$obj$env$last.par.best)
rep_opt_epsilon_NN_pref_din = spatial_model_w_epsilon_NN_w_pref_din$obj$report(spatial_model_w_epsilon_NN_w_pref_din$obj$env$last.par.best)
rep_opt_epsilon_pref_lgcp = spatial_model_w_epsilon_w_pref_lgcp$obj$report(spatial_model_w_epsilon_w_pref_lgcp$obj$env$last.par.best)
rep_opt_epsilon_NN_pref_lgcp = spatial_model_w_epsilon_NN_w_pref_lgcp$obj$report(spatial_model_w_epsilon_NN_w_pref_lgcp$obj$env$last.par.best)

rep_opt_epsilon_pref_din$pref_coef
rep_opt_epsilon_NN_pref_din$pref_coef
rep_opt_epsilon_pref_lgcp$pref_coef
rep_opt_epsilon_NN_pref_lgcp$pref_coef
opt_epsilon_pref_lgcp$par["lgcp_intercept"]
opt_epsilon_NN_pref_lgcp$par["lgcp_intercept"]

#opt_spa_NN = nlminb(spatial_model_w_epsilon_NN$obj$par, spatial_model_w_epsilon_NN$obj$fn, spatial_model_w_epsilon_NN$obj$gr, control = list(eval.max = 10000, iter.max = 10000))
#rep_epsilon = spatial_model_w_epsilon$obj$report()
#rep_epsilon_NN = spatial_model_w_epsilon_NN$obj$report()

#sd_rep = sdreport(simple_spatial_model$obj)
#sd_rep_NN = sdreport(spatial_model_w_epsilon_NN$obj)
rep_opt_epsilon_pref_din$MargSD_epsilon
rep_opt_epsilon_NN_pref_din$MargSD_epsilon
rep_opt_epsilon_pref_lgcp$MargSD_epsilon
rep_opt_epsilon_NN_pref_lgcp$MargSD_epsilon

rep_opt_epsilon_pref_din$Range_epsilon
rep_opt_epsilon_NN_pref_din$Range_epsilon
rep_opt_epsilon_pref_lgcp$Range_epsilon
rep_opt_epsilon_NN_pref_lgcp$Range_epsilon

## spatial plots
proj_epsilon_din = get_projection(obj = spatial_model_w_epsilon_w_pref_din$obj, data = spatial_model_w_epsilon_w_pref_din$tmb_data, projection_df = full_proj_df, time_variable_label = "year")
proj_epsilon_NN_din = get_projection(obj = spatial_model_w_epsilon_NN_w_pref_din$obj, data = spatial_model_w_epsilon_NN_w_pref_din$tmb_data, projection_df = full_proj_df, time_variable_label = "year")
proj_epsilon_lgcp = get_projection(obj = spatial_model_w_epsilon_w_pref_lgcp$obj, data = spatial_model_w_epsilon_w_pref_lgcp$tmb_data, projection_df = full_proj_df, time_variable_label = "year")
proj_epsilon_NN_lgcp = get_projection(obj = spatial_model_w_epsilon_NN_w_pref_lgcp$obj, data = spatial_model_w_epsilon_NN_w_pref_lgcp$tmb_data, projection_df = full_proj_df, time_variable_label = "year")
z_range = range(c(proj_epsilon_din$predicted_y, proj_epsilon_NN_din$predicted_y, 
                  proj_epsilon_lgcp$predicted_y,    proj_epsilon_NN_lgcp$predicted_y))
...
for(t in 1:n_t) {
  print(years[t])
  df = data.frame(subset(proj_epsilon_din, proj_epsilon_din$year == years[t]))
  plt = ggplot(df, aes(x = x, y = y, fill = predicted_y)) +
    geom_tile() +
    ggtitle("Dinsdale") +
    scale_fill_gradientn(colours=c("white","orange","red","dark red"), limits = z_range)
  df = data.frame(subset(proj_epsilon_NN_din, proj_epsilon_NN_din$year == years[t]))
  ...
  df = data.frame(subset(proj_epsilon_lgcp, proj_epsilon_lgcp$year == years[t]))
  plt2 = ggplot(df, aes(x = x, y = y, fill = predicted_y)) +
    geom_tile() +
    ggtitle("LGCP") +
    scale_fill_gradientn(colours=c("white","orange","red","dark red"), limits = z_range)
  
  df = data.frame(subset(proj_epsilon_NN_lgcp, proj_epsilon_NN_lgcp$year == years[t]))
